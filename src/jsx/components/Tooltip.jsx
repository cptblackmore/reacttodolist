...
function Tooltip({ children, text }) {
  ...
  function calculatePosition() {
    ...
    if (spaceRight + wrapperWidth / 2 - edgeOffset >= tooltipWidth / 2 && spaceLeft + wrapperWidth / 2 - edgeOffset >= tooltipWidth) {
  ...
  return <div className={`tooltip-wrapper ${isEntered ? 'entered' : ''}`}
              ref={wrapperRef}
    ...
    <style jsx>{`
      .tooltip-wrapper {
        ...
        &.entered .tooltip, &.entered .tooltip-arrow {
          opacity: 1;
        }
      }
