...
function App() {
  const [currentTheme, setCurrentTheme] = useState(
    JSON.parse(localStorage.getItem("theme")) || themes[1],
  );
  useEffect(() => {
    ...
    <ThemeContext.Provider value={currentTheme}>
      <div className="App">
        ...
        <div className="copyright">
          ...
          <a href="https://github.com/cptblackmore" className="nickname">
            cptblackmore
          </a>
          . Visit my&nbsp;
          <a href="https://github.com/cptblackmore/reacttodolist">repository</a>
          &nbsp;for details.
        </div>
      </div>
